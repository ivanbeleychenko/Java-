...
public class Main {
    public static void main(String[] args) {
        ...
        an_integer(2);
        System.out.println(ger_int(-35));
        duplicated_line("opoo", 5);
        System.out.println(type_year(2024));
    ...
    //Задание 6
    public static void an_integer(int a) {
        if (a >= 0 ) {
    ...
    //Задание 7
    public static boolean ger_int(int a){
        if (a >= 0){
        return false;
        } else {
            return true;
    ...
    //Задание 8
    public static void duplicated_line(String str, int b){
        for (int i = 0; i < b; i++){
    ...
    // Задание 9
    public static boolean type_year(int year){
